# Polyphonic Reading Selection

## Purpose

Define explicit, stable selection of a polyphonic Han character's annotated reading through OpenType shaping while preserving compatible rendering when selection is unavailable.
